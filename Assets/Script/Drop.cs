...
public class Drop : MonoBehaviour
{
    ...
    public Vector2 pos, size, old_pos;
    Rigidbody2D rb;
    ...
    void Update()
    {
        if (Physics2D.OverlapBox(old_pos + pos, size, 0, playerMask))
        {
    ...
    {
        Gizmos.DrawWireCube(new Vector2(transform.position.x + pos.x, transform.position.y + pos.y), size);
